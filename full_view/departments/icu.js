...
export const props = [
  ...
  prop(3, 32, 12, 3.4, 1.3, "bed"),
  prop(3, 38, 12, 3.4, 1.3, "bed"),
  prop(3, 53, 9, 3.4, 1.3, "bed"),
  prop(3, 59, 9, 3.4, 1.3, "bed"),
  prop(3, 53, 12, 3.4, 1.3, "bed"),
  prop(3, 59, 12, 3.4, 1.3, "bed"),
  prop(3, 11, 24, 3.4, 1.3, "screen"),
  prop(3, 33, 24, 3.5, 1.2, "sofa"),
  prop(3, 53, 24, 3.4, 1.3, "bed"),
  prop(3, 59, 24, 3.4, 1.3, "bed"),
  prop(3, 53, 27, 3.4, 1.3, "bed"),
  prop(3, 59, 27, 3.4, 1.3, "bed"),
  elevatorProp(3),
];
